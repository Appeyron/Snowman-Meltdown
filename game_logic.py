...
def display_game_state(
    ...
    Args:
        ...
        guessed_letters (list): Letters guessed by the user.
    """
    print("\n" + "=" * 30)
...
def is_word_guessed(
    ...
    """
    Check whether the complete word was guessed.
    ...
    Returns:
        bool: True if the word is fully guessed.
    """
    for letter in secret_word:
